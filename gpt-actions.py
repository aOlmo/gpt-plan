...
if __name__ == '__main__':
    ...
    DOMAINS = {"wiki": wiki}  # {"win": win, "cook": cook, "wiki": wiki}
    MAX_SENTS = 100

    gpt3_temp = 0  # Set to 0 for reproducibility
    gpt3_max_tokens = 100
    selected_engines = ["ada", "babbage"]

    results_file = "data.csv"
    openai.api_key = os.environ["OPENAI_API_KEY"]
    n_examples_list = [4, 3, 2, 1]  # 1: Random, 2: Excl+Opt 3: Es+Ex+Op 4: Random +prev
    ...
    for n_examples in n_examples_list:
        ...
        for gpt3_engine in selected_engines:
            for domain_name in DOMAINS:
                print("ENGINE: {} | DOMAIN: {} | N_EXAMPLES: {}\n{}".format(gpt3_engine, domain_name, n_examples,
                                                                            "-" * 28))
                ...
                for i, test_sample in enumerate(pbar):
                    ...
                    gpt3_response, err_flag = send_query_gpt3(query)
